        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-[2fr_1fr_1fr_1fr_1fr] gap-x-4 gap-y-8 mb-12">
          <div className="md:col-span-2 lg:col-span-1">
            ...
            <div className="flex flex-col sm:flex-row w-full gap-2">
              <Input 
                ...
                className="bg-black border border-gray-600 rounded-md w-full text-gray-400 pl-4"
              />
              <Button 
                className="bg-[#4C6FFF] hover:bg-[#4C6FFF]/90 text-white rounded-md px-6 mt-2 sm:mt-0"
              >
                Subscribe
              </Button>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="/help-center" className="text-gray-400 hover:text-white">Help Center</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="/cookie" className="text-gray-400 hover:text-white">Cookie Policy</a></li>
              <li><a href="/acceptable-use" className="text-gray-400 hover:text-white">Acceptable Use</a></li>
