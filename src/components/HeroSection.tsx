        ...
        <div className="flex flex-col justify-center space-y-6">
          ...
          >
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
              <Button className="bg-blue-600 hover:bg-blue-700 dark:bg-blue-500 dark:hover:bg-blue-600 text-white px-6 py-3 text-lg flex items-center gap-2 transition-colors duration-300">
